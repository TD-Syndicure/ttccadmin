    ...
    const RenderMissions = () => {
            ...
            return (
                <div className="indivMission addAMission">
                    <div className="missionInfo">
                        ...
                        <h3>LORE: <textarea className="text-black" onChange={(e) => setLore(e.target.value)} /></h3>
        ...
        const DeleteMission = ({ mission, index }: { mission: any, index: any }) => {
            ...
            const HandleReturn = () => {
                ...
                const [chimpPercent, setChimpPercent]: any = useState(mission.data.items.nft.chance * 100)
                const [traitPercent, setTraitPercent]: any = useState(mission.data.items.chimp.chance * 100)
